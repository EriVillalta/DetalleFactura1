        ...
        <td>
          ...
          <div class="panel panel-default">
              ...
              <div class="tablecontainer">
                          <c:if test="${!empty ListaDetalleFactura}">
                            <table border="1">
                                <tr>
                                    <th>N°Factura</th>
                                    <th>Producto</th>
                ...
                <c:forEach items="${ListaDetalleFactura}" var= "dato">   
                <tr>
                    <td><c:out value="${dato.numeroFactura}"/></td>
                    <td><c:out value="${dato.idProducto}"/></td>
                    <td><c:out value="${dato.cantidad}"/></td>
                    <td><c:out value="${dato.precioVenta}"/></td>
                    
                    
                    <td>
                        <a href="eliminarDetalleFactura?id=${dato.idDetalle}">Eliminar</a>&emsp14;  
                        <a href="modificarDetalleFacturaX?id=${dato.idDetalle}">Modificar</a>
                    </td>
                </tr>
                </c:forEach>
                            </table>
