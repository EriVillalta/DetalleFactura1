...
@NamedQueries({
    ...
    , @NamedQuery(name = "Tmp.findByIdTmp", query = "SELECT t FROM Tmp t WHERE t.idTmp = :idTmp")
    , @NamedQuery(name = "Tmp.findByIdProducto", query = "SELECT t FROM Tmp t WHERE t.idProducto = :idProducto")
    , @NamedQuery(name = "Tmp.findByCantidadTmp", query = "SELECT t FROM Tmp t WHERE t.cantidadTmp = :cantidadTmp")
    , @NamedQuery(name = "Tmp.findByPrecioTmp", query = "SELECT t FROM Tmp t WHERE t.precioTmp = :precioTmp")
    , @NamedQuery(name = "Tmp.findBySessionId", query = "SELECT t FROM Tmp t WHERE t.sessionId = :sessionId")})
