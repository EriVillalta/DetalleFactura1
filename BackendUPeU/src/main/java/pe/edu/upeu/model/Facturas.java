...
@NamedQueries({
    ...
    , @NamedQuery(name = "Facturas.findByIdVendedor", query = "SELECT f FROM Facturas f WHERE f.idVendedor = :idVendedor")
    , @NamedQuery(name = "Facturas.findByCondiciones", query = "SELECT f FROM Facturas f WHERE f.condiciones = :condiciones")
    , @NamedQuery(name = "Facturas.findByTotalVenta", query = "SELECT f FROM Facturas f WHERE f.totalVenta = :totalVenta")
